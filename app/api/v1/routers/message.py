...
async def create_message(message: MessageAddToChatCreate, user: CurrentActiveVerifiedUserDep, uow: AsyncUOWDep):
...
async def get_message(message_id: int, user: CurrentActiveVerifiedUserDep, uow: AsyncUOWDep):
