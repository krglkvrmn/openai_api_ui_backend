...
from app.schemas.app.prompt import SystemPromptRead, SystemPromptResponse
...
@prompt_router.delete('/system/deletePrompt/{prompt_id}', response_model=SystemPromptResponse)
